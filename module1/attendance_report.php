        ...
        <div class="">
            ...
            <section class="content-header">
                <h1 class="text-center">
					 3ኛ መደበኛ ጠቅላላ ጉባዔ ምልዐተ ጉባዔ መግለጫ
                </h1>
            </section>
                ...
                <div class="container ">
                    <div class="row">
                        ...
                        <div class="col-sm-12 text-right">
                            <button class="btn btn-primary" onclick="printReport('AttendanceReport');">Print</button>
                        </div>
                        <div id="print_content">
                            <div id="Attendance_report_att">
                                <?php
...
<script>
    function showReport(title) {
        ...
        xhttp.open("GET", "report.php?actionrep=" + title + "&nationality=" + nationality + "&sort=" + sort, true); //"&start_date=" + start_date + "&end_date=" + end_date ,
        xhttp.send();
    }
    ...
    function printReport(title) {
        ...
        print_content = "<div class='h3 text-left text-primary'>" + "Attendance " + " Report" + "<img id='myImg' src='../images/goh_logo.png' width='200' height='60' align='right'>" + "<br><h4><b>ቀን : </b>ህዳር 12 ቀን 2017 ዓ.ም</h4>" + "</div><br> <h2 class='text-center'> 3ኛ መደበኛ ጠቅላላ ጉባዔ ምልዐተ ጉባዔ መግለጫ </h2>" + print_content;//<!--?= date('d-M-Y'); ?-->
...
<script>
    function ExcelReport(tableID, filename = '') {
        ...
        // Specify file name
        filename = filename ? filename + exte + '.xls' : 'AttendanceReport' + exte + '.xls';
    ...
    function PDFReport(tableID, filename = '') {
        ...
        // Specify file name
        filename = filename ? filename + exte + '.pdf' : 'AttendanceReport' + exte + '.pdf';
