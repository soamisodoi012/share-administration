                ...
                <div class="container ">
                    <div class="row">
                        ...
                        <div class="col-sm-12 text-right">
                            <button class="btn btn-primary" onclick="printReport('ElectionResult1');">Print</button>
                            <button class="btn btn-primary" onclick="ExcelReport('Election_report_res1');">Excel</button>
                        </div>

                        <div class="col col-md-12 table-responsive">
                            <div id="print_content" class="table-responsive">

                                <table class="table table-bordered table-striped table-hover" id="Election_report_res1">
                                    <?php
...
<script>
    function showReport(title) {
        ...
        xhttp.open("GET", "report.php?actionres1=" + title, true);
        xhttp.send();
    }
    ...
    function printReport(title) {
        ...
        print_content = "<div class='h3 text-left text-primary'>" + "Election Result1 " + " Report" + "<img id='myImg' src='../images/avatar.png' width='50' height='50' align='right'> " + "<br><h4><b>Report Date : </b><?= date('d-M-Y'); ?></h4>" + "</div><br>" + print_content;
...
<script>
    function ExcelReport(tableID, filename = '') {
        ...
        // Specify file name
        filename = filename ? filename + exte + '.xls' : 'ElectionResult1' + exte + '.xls';
    ...
    function PDFReport(tableID, filename = '') {
        ...
        // Specify file name
        filename = filename ? filename + exte + '.pdf' : 'ElectionResult1' + exte + '.pdf';
