            ...
            <div class="container " >
                <div class="row">
                    ...
                    <div class="col-sm-12 text-right">
                        <button class="btn btn-primary" onclick="printReport('Shareholderabb');">Print</button>
                        <button class="btn btn-primary" onclick="ExcelReport('Shareholder_report_abb');">Excel</button>
                    </div>

                    <div class="col col-md-12 table-responsive">
                        <div id="print_content" class="table-responsive">
                            <table class="table table-bordered table-striped table-hover" id="Shareholder_report_abb">
                            <?php
...
function showReport(title) {
    ...
    xhttp.open("GET", "report.php?actionab=" + title  + "&nationality=" + nationality  + "&sort=" + sort  ,true);//"&start_date=" + start_date + "&end_date=" + end_date ,
    xhttp.send();
  }
  ...
  function printReport(title) {
    ...
    print_content = "<div class='h3 text-left text-primary'>" + "Absent Shareholders List" + " Report" + "<img id='myImg' src='../images/avatar.png' width='50' height='50' align='right'> " + "<br><h4><b>Report Date : </b><?= date('d-M-Y'); ?></h4>" + "</div><br>" + print_content;
...
<script>
    ...
    function ExcelReport(tableID, filename = ''){
        ...
        // Specify file name
        filename = filename?filename+exte+'.xls':'AbsentShareholders'+ exte +'.xls';
    ...
    function PDFReport(tableID, filename = ''){
        ...
        // Specify file name
        filename = filename?filename+exte+'.pdf':'AbsentShareholders'+ exte +'.pdf';
