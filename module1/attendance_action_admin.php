<?php
    ...
    elseif(isset($_POST['rm_attendance'])){
		$id = $_POST['id'];
        ...
        if($role_a == 'admin'){
            ...
            $sql_rm = "DELETE FROM att_shareholder WHERE id = $id";

            if($conn->query($sql_rm)){
                $_SESSION['success'] = 'Attendance removed Sccessfully !!! Shareholder ID : '.$id;
            }
            else{
                $_SESSION['error'] = $conn->error;
            }
	...
	header('location: att_shareholders_admin.php');
