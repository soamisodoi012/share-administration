          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                $sqn = 0;
                $sql = "SELECT sh.id as id, sh.name_e as name_e, sh.subscribed_share as subscribed_share, sh.paid_share as paid_share, sh.nationality as nationality, sh.phone_number as phone_number
                  FROM shareholder as sh
                  WHERE sh.id != '99999999'
                  ORDER BY sh.name_e ASC"; //IN ('8011','8010','8014')
