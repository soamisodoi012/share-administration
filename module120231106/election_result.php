...
<script>
    function showReport(title) {
        ...
        xhttp.open("GET", "report.php?actionres=" + title, true);
        xhttp.send();
    }
    ...
    function printReport(title) {
        ...
        print_content = "<div class='h3 text-left text-primary'>" + "Election Result " + " Report" + "<img id='myImg' src='../images/avatar.png' width='50' height='50' align='right'> " + "<br><h4><b>Report Date : </b><?= date('d-M-Y'); ?></h4>" + "</div><br>" + print_content;
