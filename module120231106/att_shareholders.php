        ...
        <div class="box">
          ...
          <div class="hidden" id="print_content_cert">
            ...
            <div class="">
              ...
              <h5 class="text-left" style="font-family:Ebrima"><b>ማሳሰቢያ፣</b></h5>
              <h5 class="text-left" style="font-family:Ebrima">Ø ባለአክሲዮኑ ይህንን የድምፅ መስጫ ቅፅ በሚስጢር በመሙላት ድምፅ ይሰጣሉ፡፡</h5>
              <h5 class="text-left" style="font-family:Ebrima">Ø የዳይሬክተሮች ቦርድ አባልነት ለመምረጥ ከላይ ከቀረቡት ስድስት (12) እጩዎች መካከል ሶስቱን (6) ብቻ መምረጥ ይችላሉ፡፡</h5>
              <h5 class="text-left" style="font-family:Ebrima">Ø የመረጧቸውን ሶስት (6) እጩዎች ሙሉ ስም ከላይ በተቀመጠው ባዶ ቦታ ላይ በመፃፍ እና በመፈረም የተሞላውን የድምፅ መስጫ ቅፅ ለሰብሳቢዎቹ ያስረክባሉ፡፡</h5>
              <h5 class="text-left" style="font-family:Ebrima"><b>ይህ የድምፅ መስጫ ቅፅ ከሚመለከቱት ባንዱ ምክንያት ዋጋ ያጣል፡፡</b></h5>
              <ul>
