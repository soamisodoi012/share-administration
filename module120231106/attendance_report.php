...
<script>
    ...
    function printReport(title) {
        ...
        print_content = "<div class='h3 text-left text-primary'>" + "Attendance " + " Report" + "<img id='myImg' src='../images/goh_logo.png' width='200' height='60' align='right'>" + "<br><h4><b>ቀን : </b>ህዳር 15 ቀን 2016 ዓ.ም</h4>" + "</div><br>" + print_content;//<!--?= date('d-M-Y'); ?-->
