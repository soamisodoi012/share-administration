        ...
        <div class="">
            ...
            <section class="content-header">
                <h1 class="text-center">
                    Election Result - NON-Infulential
                </h1>
            </section>
...
<script>
    function showReport(title) {
        ...
        xhttp.open("GET", "report.php?actionelc2=" + title + "&nationality=" + nationality + "&sort=" + sort, true); //"&start_date=" + start_date + "&end_date=" + end_date ,
        xhttp.send();
    }
    ...
    function printReport(title) {
        ...
        print_content = "<div class='h3 text-left text-primary'>" + "Election Result 2" + " Report" + "<img id='myImg' src='../images/avatar.png' width='50' height='50' align='right'> " + "<br><h4><b>Report Date : </b><?= date('d-M-Y'); ?></h4>" + "</div><br>" + print_content;
...
<script>
    function ExcelReport(tableID, filename = '') {
        ...
        // Specify file name
        filename = filename ? filename + exte + '.xls' : 'ElectionResult2' + exte + '.xls';
    ...
    function PDFReport(tableID, filename = '') {
        ...
        // Specify file name
        filename = filename ? filename + exte + '.pdf' : 'ElectionResult2' + exte + '.pdf';
